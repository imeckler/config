...
syntax match ocamlNiceOperator "'a" conceal cchar=α
syntax match ocamlNiceOperator "'b" conceal cchar=β
syntax match ocamlNiceOperator "'c" conceal cchar=γ
syntax match ocamlNiceOperator "'z" conceal cchar=ζ
syntax match ocamlNiceOperator "'d" conceal cchar=δ
...
if s:extraConceal
    ...
    syntax match ocamlNiceOperator ">=\ze[^>]" conceal cchar=≳
    syntax match ocamlNiceOperator "=>" conceal cchar=⇒
" can't find a font that supports this character
    syntax match ocamlNiceOperator "\:\:" conceal cchar=∷
    syntax match ocamlNiceOperator "++" conceal cchar=⧺
"    syntax match ocamlNiceOperator "\^" conceal cchar=⧺
